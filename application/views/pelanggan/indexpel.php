  ...
  <header id="header" class="fixed-top d-flex align-items-center">
    <div class="container d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          <li><a class="nav-link scrollto active">Beranda</a></li>
          <li><a class="nav-link scrollto" >Layanan</a></li>
    ...
    <!-- ======= Hero Section ======= -->
	 <section id="hero" class="d-flex flex-column justify-content-center align-items-center" style="background-image:url('assets/img/cover1.jpg')";>
        ...
        <div class="row">
          ...
          <div class="col-lg-8 pt-6 pt-lg-5">
            ...
            <p style="color:white">
				...
				<div class="col-lg-4">
            <img src="assets/img/cover3.jpg" class="img-fluid" alt="">
          </div>
      </div>
    </section>
    <!-- End About Section -->
        ...
        <div class="row produk-container">
          ...
          <div class="col-lg-4 col-md-6 produk-item filter-app wow fadeInUp">
            <div class="produk-wrap">
              <figure>
                <img src="assets/img/cover4.jpg" class="img-fluid" alt="">
              </figure>
